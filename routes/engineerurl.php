...
Route::middleware(['isEngineer'])->prefix('engineer')->group(function () {
    ...
    Route::get('/fetchorderinfo/{id}', [engineerController::class, 'fetchorderinfo'])->name('fetchorderinfo');
    Route::get('/acceptappointment/{id}', [engineerController::class, 'acceptappointment'])->name('acceptappointment');
    Route::get('/cancelappointment/{id}', [engineerController::class, 'cancelappointment'])->name('cancelappointment');
});
