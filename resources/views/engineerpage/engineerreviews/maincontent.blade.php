        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                    onclick="modelhide()">Close</button>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-4 col-xl-3 theiaStickySidebar" translate="no">
                ...
                <!-- Profile Sidebar -->
                <div class="p-2 mb-3" id="filter_eng" style="cursor:pointer">Sidebar Nav<i
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="comment-body" style="width:90%;">
                                            <div class="meta-data">
                                                ...
                                                <span
                                                    class="comment-date">{{ $engrcmts->created_at->diffForHumans() }}</span>
                                            ...
                                            <div class="comment-reply">
                                                <a class="comment-btn" href="javascript:void(0)"
                                                    onclick="showreplydiv({{ $engrcmts->engrid }},{{ $engrcmts->clientid }},{{ $engrcmts->id }})">
                                    ...
                                    @if ($engrcmts->replies != null)
                                        ...
                                        <ul class="comments-reply">
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <img class="avatar rounded-circle" alt="User Image"
                                                        src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-02.jpg') }}">
