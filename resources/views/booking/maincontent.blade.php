						...
						<div class="col-12">
								...
								<div class="card-body">
									<div class="booking-doc-info">
										...
										<div class="booking-info">
											...
											<p class="text-muted mb-0"><i class="fas fa-map-marker-alt"></i> {{ $engr->city.', '.$engr->country }}</p>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="time-slot">
												<ul class="clearfix">
													<li class="listno">
														<a class="timing selected" href="javascript:void(0)" onclick="get_time(0,1)">
															<span>9:00</span> <span>AM</span>
														</a>
														...
														<input type="time" class="form-control customtime timing"  onclick="get_time(0,4)" value="<?php date_default_timezone_set("Asia/Karachi"); $c_d = date('h:i:sa');echo date("H:i", strtotime($c_d));?>">
													</li>
													<li class="listno">
														...
														<input type="time" class="form-control customtime timing" onclick="get_time(1,4)" value="<?php date_default_timezone_set("Asia/Karachi"); $c_d = date('h:i:sa');echo date("H:i", strtotime($c_d));?>">
													</li>
													<li class="listno">
														...
														<input type="time" class="form-control customtime timing" onclick="get_time(2,4)" value="<?php date_default_timezone_set("Asia/Karachi"); $c_d = date('h:i:sa');echo date("H:i", strtotime($c_d));?>">
													</li>
													<li class="listno">
														...
														<input type="time" class="form-control customtime timing" onclick="get_time(3,4)" value="<?php date_default_timezone_set("Asia/Karachi"); $c_d = date('h:i:sa');echo date("H:i", strtotime($c_d));?>">
													</li>
													<li class="listno">
														...
														<input type="time" class="form-control customtime timing " onclick="get_time(4,4)" value="<?php date_default_timezone_set("Asia/Karachi"); $c_d = date('h:i:sa');echo date("H:i", strtotime($c_d));?>">
													</li>
													<li class="listno">
														...
														<input type="time" class="form-control customtime timing" onclick="get_time(5,4)" value="<?php date_default_timezone_set("Asia/Karachi"); $c_d = date('h:i:sa');echo date("H:i", strtotime($c_d));?>">
													</li>
													<li class="listno">
														...
														<input type="time" class="form-control customtime timing" onclick="get_time(6,4)" value="<?php date_default_timezone_set("Asia/Karachi"); $c_d = date('h:i:sa');echo date("H:i", strtotime($c_d));?>">
													</li>
												</ul>
											</div>
											<!-- /Time Slot -->
							...
							<div class="submit-section proceed-btn text-right">
								...
								<form method="post"  action="{{ route('proceed') }}">
									@csrf
									<input type="text" name="date" id="date" hidden required focusable>
			...
			<script>
				function get_time(rowid,colno){
					...
					if(colno == 4){
						...
						$('#selectdate').val(getdate+'-'+getmonth+'-'+getYear);
						...
						if(gethour[0] > 11){
							...
							$('#time').val(converthour+':'+gethour[1]+' PM');
						}else{
							$('#time').val($gethour[0]+':'+gethour[1]+' AM');
						}
						...
						$('#time').val(spantime.innerText +' '+spanap.innerText);
				...
				function updatedatecol(date,sign){
					...
					$.each(daynamespan,function(ref,value){
						...
						console.log(ntweek);
						$(daynamespan[ref]).text(['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'][ntweek.getDay()]);
						var curr_date = ntweek.getDate();
						var curr_month = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'July', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'][ntweek.getMonth()]
