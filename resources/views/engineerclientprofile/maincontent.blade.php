			...
			<div class="content">
				<div class="container-fluid">
					...
					<div class="row">
								...
								<ul class="list-group list-group-flush">
									<li class="list-group-item">
										<div class="media align-items-center">
											<div class="mr-3">
												<img alt="Image placeholder" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-02.jpg') }}" class="avatar  rounded-circle">
											</div>
											<div class="media-body">
												<h5 class="d-block mb-0">Darren Elder </h5>
												<span class="d-block text-sm text-muted">Civil Engineer</span>
						...
						<div class="col-md-12 col-lg-8 col-xl-9 dct-appoinment">
							<div class="card">
								<div class="card-body pt-0">
									<div class="user-tabs">
										<ul class="nav nav-tabs nav-tabs-bottom nav-justified flex-wrap">
											...
											<li class="nav-item">
												<a class="nav-link" href="#pres" data-toggle="tab"><span>Problems</span></a>
											</li>
											{{-- <li class="nav-item">
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-02.jpg') }}" alt="User Image">
																			</a>
																			<a href="doctor-profile.html">Darren Elder <span>Civil Engineer</span></a>
																		</h2>
																	</td>
															...
															<tbody>
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Ruby Perrin <span>Civil Engineer</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-03.jpg') }}" alt="User Image">
																			</a>
																			<a href="doctor-profile.html">Dr. Deborah Angel <span>Electrical Engineer</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-04.jpg') }}" alt="User Image">
																			</a>
																			<a href="doctor-profile.html">Dr. Sofia Brient <span>Mechanical Engineer</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-05.jpg') }}" alt="User Image">
																			</a>
																			<a href="doctor-profile.html">Marvin Campbell <span>Civil Engineer</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-06.jpg') }}" alt="User Image">
																			</a>
																			<a href="doctor-profile.html">Dr. Katharine Berthold <span>Chemical Engineer</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-07.jpg') }}" alt="User Image">
																			</a>
																			<a href="doctor-profile.html">Dr. Linda Tobin <span>Mechanical Engineer</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-08.jpg') }}" alt="User Image">
																			</a>
																			<a href="doctor-profile.html">Dr. Paul Richard <span>Software Engineer</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-09.jpg') }}" alt="User Image">
																			</a>
																			<a href="doctor-profile.html">John Gibbs <span>Civil Engineer</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{ asset('newpanel/assets/img/doctors/doctor-thumb-10.jpg') }}" alt="User Image">
																			</a>
																			<a href="doctor-profile.html">Olga Barlow <span>Civil Engineer</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Dr. Marvin Campbell <span>Civil Engineer</span></a>
																		</h2>
																	</td>
																	<td>$600</td>
																	<td>10 Nov 2019</td>
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Dr. Katharine Berthold <span>Nuclear Engineer</span></a>
																		</h2>
																	</td>
																	<td>$200</td>
																	<td>9 Nov 2019</td>
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor-profile.html">Olga Barlow <span>Electrical Engineer</span></a>
																		</h2>
																	</td>
																	<td>$550</td>
																	<td>5 Nov 2019</td>
