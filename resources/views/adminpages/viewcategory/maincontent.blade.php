												...
												<tr>
													<td>
														<h6 class="table-avatar">
															{{ ucfirst($res->engrcategory) }}
														</h6>
													</td>
													<td><img class="rounded" src={{ asset('categorylogo/'.$res->engrcategorylogo) }} width="70px" heigth="70px"></td>
									
													<td>
														<button class="btn btn-primary p-1" onclick="editcategory({{ $res->id }})">Edit</button>
														<button class="btn btn-danger p-1 ml-2" onclick="delcategory({{ $res->id }})">Delete</button>
