						...
						<div class="col-xl-12 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									<h4 class="card-title">Create Engineer Form</h4>
								</div>
								<div class="card-body">
									<x-guest-layout>    
										<!-- Validation Errors -->
									   <x-auth-validation-errors class="mb-4" :errors="$errors" />
									<form method="POST" action="{{ route('admincreateengr') }}" enctype="multipart/form-data" class="contact-form">
										@csrf
										...
										<input type="text" name="latitude" id="latitude"  readonly> --}}
										 ...
										 <div class="form-section">
											<!-- Engineer category -->
                                            <div>
                                                <x-label for="engrcategory" style="margin-bottom:5px" :value="__('Education')" />
										...
										<div>
											...
											<x-input id="education" style="margin-bottom:10px" class="block  w-full" type="text" id="education" name="education" :value="old('education')" required autofocus />
										</div>
										<!-- specialize -->
										<div>
									 ...
									 <div class="form-section">
										...
										<button type="submit" class="btn bg-success float-right  mt-2">Save</button>
										 </div>
