...
<button type="submit"> <img src="{{ asset('adminpanel/img/icon/icon_search.svg') }}" alt=""> </button>
</form>
</div> --}}
</div>
...
<li>
<a class="bell_notification_clicker" href="#"> <img src="{{ asset('adminpanel/img/icon/bell.svg') }}" alt="">
<span>04</span>
</a>
...
<a href="#"><img src="{{ asset('adminpanel/img/staf/2.png') }}" alt=""></a>
</div>
...
<div class="single_notify d-flex align-items-center">
<div class="notify_thumb">
<a href="#"><img src="{{ asset('adminpanel/img/staf/4.png') }}" alt=""></a>
</div>
<div class="notify_content">
...
<div class="single_notify d-flex align-items-center">
<div class="notify_thumb">
<a href="#"><img src="{{ asset('adminpanel/img/staf/3.png') }}" alt=""></a>
</div>
<div class="notify_content">
...
<li>
<a class="CHATBOX_open" href="#"> <img src="{{ asset('adminpanel/img/icon/msg.svg') }}" alt=""> <span>01</span> </a>
</li>
</div>
<div class="profile_info">
<img src="{{ asset('adminpanel/img/client_img.png') }}" alt="#">
...
<h3> Register Engineer</h3>
</div>
</div>
<div class="col-lg-6">
<div class="dashboard_breadcam text-end">
<p><a href="index.html">Dashboard</a> <i class="fas fa-caret-right"></i> Admin Info</p>
</div>
</div>
</div>
</div>
...
<div class="col-lg-11 col-xl-11">
    <div class="main-title">
     <h3 class="test-center" style="text-align: center;
    margin-bottom: 30px;">Engineer Request</h3>
    </div>
<div >
 <div >
...
<p class="mb-2 text-muted text-truncate"><i class="fas fa-circle text-primary me-2 font-size-10 me-1"></i> This Year :</p>
...
<div class="col-sm-4 text-center">
<div class="mt-4 mt-sm-0">
<p class="mb-2 text-muted text-truncate"><i class="fas fa-circle text-success font-size-10 me-1"></i> Previous Year :</p>
<div class="d-inline-flex align-items-center">
...
<table class="table" id="requesttable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{ $val->name }}</td>
      <td><span class="bages ">Pending</span></td>

      <td>
        <form action="{{ route('aproveenge',$userid) }}" method="post">
        @csrf
...
<h3 className="m-0">Users according to packages</h3>
</div>
</div>
...
<div className="white_box mb_30 card_height_100">
<div className="box_header ">
<div className="main-title">
<h3 className="mb_25">Overview</h3>
</div>
</div>
<div className="activity_progressbar">
<div className="single_progressbar d-flex">
...
<div className="box_header m-0">
<div className="main-title">
<h3 className="m-0">Web Visitor and trafic</h3>
</div>
</div>
...
<div className="white_box QA_section card_height_100 blud_card">
<div className="box_header m-0">
<div className="main-title">
<h3 className="m-0 text_white">2400 + New Users</h3>
</div>
</div>
...
<img src="{{ asset('adminpanel/img/users_img.png') }}" alt="">
</div>
</div>
</div> --}}
{{-- <div className="col-lg-4">
...
<div className="box_header m-0">
<div className="main-title">
<h3 className="m-0">Listings according to Category</h3>
</div>
</div>
<div className="QA_table ">
...
<div className="box_header m-0">
<div className="main-title">
<h3 className="m-0">Claimed Listings</h3>
</div>
</div>
<div className="QA_table ">
...
<div className="box_header m-0">
<div className="main-title">
<h3 className="m-0">Reported Listings</h3>
</div>
</div>
<div className="QA_table ">
...
<div className="notification_read_btn mb_10">
<a href="#" className="notification_btn">Read</a>
</div>
</div>
</li>
<li>
...
<div className="box_header m-0">
<div className="main-title">
<h3 className="m-0">Device</h3>
</div>
</div>
<div id="bar-chart-6" className=""></div>
</div>
</div> --}}
{{-- <div className="col-lg-3">
...
<div className="box_header">
<div className="main-title">
<h3 className="m-0">Browser</h3>
</div>
</div>
<div className="casnvas_box">
<canvas height="210" width="210" id="canvasDoughnut"></canvas>
</div>
<div className="legend_style legend_style_grid mt_10px">
<li className="d-block"> <span style="background-color: #525CE5;"></span>Chrome</li>
<li className="d-block"> <span style="background-color: #9C52FD;"></span> Mojila</li>
<li className="d-block"> <span style="background-color: #3B76EF"></span> Safari</li>
<li className="d-block"> <span style="background-color:#00BFBF;"></span> Opera</li>
<li className="d-block"> <span style="background-color:#FFA70B;"></span> Microsoft Edg</li>
</div>
</div>
</div> --}}
</div>
...
<img src="{{ asset('adminpanel/img/staf/1.png') }}" alt="">
</div>
</a>
</li>
<li>
<a href="#">
<div className="member_thumb">
<img src="{{ asset('adminpanel/img/staf/2.png') }}" alt="">
</div>
</a>
</li>
<li>
<a href="#">
<div className="member_thumb">
<img src="{{ asset('adminpanel/img/staf/3.png') }}" alt="">
</div>
</a>
</li>
<li>
...
<a href="#">
<div className="member_thumb">
<img src="{{ asset('adminpanel/img/staf/5.png') }}" alt="">
</div>
</a>
</li>
<li>
...
<img src="{{ asset('admin') }}img/staf/1.png" alt="">
</div>
